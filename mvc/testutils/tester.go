...
func Querier(t ...string) *builder.QueryBuilder   { return _t.tabler.Querier(utils.Variable(t, "")) }
func Inserter(t ...string) *builder.InsertBuilder { return _t.tabler.Inserter(utils.Variable(t, "")) }
func Updater(t ...string) *builder.UpdateBuilder  { return _t.tabler.Updater(utils.Variable(t, "")) }
func Deleter(t ...string) *builder.DeleteBuilder  { return _t.tabler.Deleter(utils.Variable(t, "")) }
